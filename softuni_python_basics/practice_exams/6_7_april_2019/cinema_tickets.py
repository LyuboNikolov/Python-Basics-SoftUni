...
while movie_name != "Finish":
    ...
    sold_seats_per_movie = 0
    for free_tickets in range(free_seats_per_movie):
        ...
        if current_ticket == "End":
            ...
            kid_tickets += 1
        sold_seats_per_movie += 1
    percent_full_hall = sold_seats_per_movie / free_seats_per_movie * 100
...
percent_kids_tickets = kid_tickets / total_tickets * 100
